...
`
	...
	assert.Equal(t, []fileField{
		{Offset: 0x0, Length: 0x1, Label: "U8 single", Value: []byte{0xfb}},
		{Offset: 0x1, Length: 0x2, Label: "U8 array", Value: []byte{0xff, 0xd8}},

		// big endian
		{Offset: 0x3, Length: 0x2, Label: "U16BE single", Value: []byte{0xaa, 0xf0}},
		{Offset: 0x5, Length: 0x4, Label: "U16BE array", Value: []byte{0x10, 0x11, 0x20, 0x21}},
		{Offset: 0x9, Length: 0x4, Label: "U32BE single", Value: []uint8{0x11, 0x22, 0x33, 0x44}},
		{Offset: 0xd, Length: 0x8, Label: "U32BE array", Value: []uint8{0x10, 0x11, 0x12, 0x13, 0x20, 0x21, 0x22, 0x23}},
		{Offset: 0x15, Length: 0x8, Label: "U64BE single", Value: []uint8{0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}},
		{Offset: 0x1d, Length: 0x10, Label: "U64BE array", Value: []uint8{0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27}},

		// little endian
		{Offset: 0x2d, Length: 0x2, Label: "U16LE single", Value: []byte{0xaa, 0xf0}},
		{Offset: 0x2f, Length: 0x4, Label: "U16LE array", Value: []byte{0x10, 0x11, 0x20, 0x21}},
		{Offset: 0x33, Length: 0x4, Label: "U32LE single", Value: []uint8{0x11, 0x22, 0x33, 0x44}},
		{Offset: 0x37, Length: 0x8, Label: "U32LE array", Value: []uint8{0x10, 0x11, 0x12, 0x13, 0x20, 0x21, 0x22, 0x23}},
		{Offset: 0x3f, Length: 0x8, Label: "U64LE single", Value: []uint8{0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}},
		{Offset: 0x47, Length: 0x10, Label: "U64LE array", Value: []uint8{0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27}},
	}, ff)
}
...
`
	...
	test := []struct {
		...
		{[]byte{
			...
			{Offset: 0x0, Length: 0x1, Label: "Sig8a", Value: []byte{0xfb}},
			{Offset: 0x1, Length: 0x2, Label: "Sig8b", Value: []byte{0xff, 0xd8}},
			{Offset: 0x3, Length: 0x2, Label: "Sig16be", Value: []byte{0x4a, 0xf0}},
			{Offset: 0x5, Length: 0x4, Label: "Sig16be_array", Value: []byte{0x16, 0x17, 0x16, 0x17}},
			{Offset: 0x9, Length: 0x4, Label: "U32BE single", Value: []byte{0x12, 0x34, 0x56, 0x78}},
			{Offset: 0xd, Length: 0x8, Label: "U32BE array", Value: []byte{0x22, 0x22, 0x33, 0x33, 0x44, 0x44, 0x55, 0x55}},
		}, nil},
